...
?>             
        ...
        <div class="main_content">
            <div class="mcontainer">
                ...
                <?php 
               //print_r($this->selectclient);
                $result=$this->selectclient;
                $acctofficer=$result["accountofficer"];
                ...
                <table>
                    <thead>
                    <h2 class="text-xl font-semibold mt-7"> <?php echo $clientname; ?></h2>
                    </thead>
                    <tbody>
                        <tr><td>
                        <label>Account officer</label>
                        <form method="POST" enctype="multipart/form-data" action="<?php echo URL ;?>admassignaccountofficer/saveaccountofficer">
                                <input type="text"  name="accountofficer" value="<?php echo $acctofficer ;?>"  required>
                                <input type="hidden" name="mobile" value="<?php echo $phone ;?>">
                                <input type="submit" value="Save Account Officer"/>
                            </form>
                            </td>
                        </tr>
