...
?>             
        ...
        <?php 
         ...
         ?>  
                    ...
                    <h2 class="text-xl font-semibold mt-7"> List of CLIENTS</h2>
                    <table class="table table-striped table-dark">
                        <thead>
                    <tr><td scope="col" align="center">S/No</td>                    
                        <td scope="col" align="center">FULL NAME</td>
                        <td scope="col" align="center">MOBILE</td>    
                        <td scope="col" align="center">MANAGE ACCOUNT</td> 
                        <td scope="col" align="center">MANAGE ALLOCATION</td> 
                        <td scope="col" align="center">MANAGE OTHER DOCS</td> 
                    ...
                    <tbody>
                               ...
                               //print_r($this->listofclients);
                                ...
                                foreach ($this->listofclients as $key => $value) {
                                    # code...
                                    echo'
                                        <tr>
                                        <td scope="col" align="left">'. $sn .'</td>
                                            <td scope="col"  align="left">'. $value["name"] .'</td>
                                            <td scope="col" align="right">'. $value["phone"] .'</td>
                                            <td scope="col" align="center"><a href='. URL ."admcustomeraccount/manage/". $value["phone"] .'><input type="button" value="Manage Account"></a></td>
                                            <td scope="col" align="center"><a href='. URL ."admcustomeraccount/allocate/". $value["phone"] .'><input type="button" value="Manage Allocation"></a></td>
                                            <td scope="col" align="center"><a href='. URL ."admcustomeraccount/docs/". $value["phone"] .'><input type="button" value="Manage Docs"></a></td>
