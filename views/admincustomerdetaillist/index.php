             ...
             <div class="lg:flex lg:space-x-12">
                    ...
                    <div class="lg:w-1/4 flex-shrink-0 space-y-5">                            
                      ...
                      <div class="card">
             			...
             			<form id="myform"  method="post" enctype="multipart/form-data" action="<?php echo URL ;?>register/submitapplication">
        				<select name="listofland" >
                        <option value disabled selected>Select Land</option>
                        <?php
                        foreach($this->listofland as $lands) {
                            ?>
                            <option value="<?php echo $lands["id"]; ?>"><?php echo $lands["name"]; ?></option>
                        <?php                                }
                        ?>
                        </select>
                        <input type="submit" name="Search Customers">
                        </form>
