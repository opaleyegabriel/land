...
?>             
        ...
        <?php 
         ...
         ?>  
         <form method="POST" action="<?php echo URL  ?>admpwdchange/pwdchange" >
            <input type="text" name="oldpwd" placeholder="Enter old password" required>
            <input type="text" name="newpwd" placeholder="Enter new password" required>
