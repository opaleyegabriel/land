            ...
            <div class="lg:mt-0 lg:w-96 md:w-1/2 sm:w-2/3 mt-10 w-full">
              ...
              ?>
                  ...
                  <form enctype="multipart/form-data" action="<?php URL ;?> balogins/login_bas" method="post" class="p-6 space-y-4 relative bg-white shadow-lg rounded-lg">
                    <input type="Number" placeholder="Account Number" name="mobile" id="phone" class="with-border" required>
                    ...
                    <a href="<?php echo URL.'bachangepwd' ?>" class="text-blue-500 text-center block"> Forgot Password? </a>
                    <hr class="pb-3.5">
