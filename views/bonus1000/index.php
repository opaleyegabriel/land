                    ...
                    <div class="right_side">
                        ...
                        <div class="header_widgets">          
                            ...
                            <div uk-drop="mode: click;offset:5" class="header_dropdown profile_dropdown">
                                ...
                                <a href="<?php echo URL."bonus1000/logout"; ?>">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar_inner" data-simplebar>
                ...
                <ul>
                    ...
                    <li><a href="<?php echo URL."bonus1000" ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="text-pink-500">
                            <path fill-rule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clip-rule="evenodd" />
                            <path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z" />
            ...
            <div class="mcontainer">
                ...
                <div class="lg:flex lg:space-x-12">
                    ...
                    <div class="lg:w-1/4 flex-shrink-0 space-y-5">
                      ...
                      <h2 class="text-xl font-semibold mt-7"> BAs Bonus/Targets  </h2>
                      <div class="card">
                      <?php
                      ...
                      if(session::get("saved")){
                        echo '<h2 class="text-xl font-semibold mt-7"> N1000 Record successfully Saved and Target Created  </h2>';
                      ...
                      ?>
                      <form enctype="multipart/form-data" action="<?php echo URL."bonus1000/chargeonsales" ?>" method="post" >                       
                          <div class="card-body">  
                                <input type="text" name="acctno" value="" class="with-border"  placeholder="BAs Account Number" required>                                
                                <input type="text" name="cmobile" value="" class="with-border"  placeholder="Client Mobile Number" required>
                                <input type="submit" value="Bonus/Target">
