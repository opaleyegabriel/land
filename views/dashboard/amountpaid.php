        ...
        <div class="main_content">
            ...
            <div class="lg:flex lg:space-x-12">
                    ...
                    <div class="lg:w-1/4 flex-shrink-0 space-y-5">
                        ...
                        <?php
                       // echo "<pre>";
                        //print_r($this->amountpaid);
                            
                            //list transaction details
                        	foreach ($this->amountpaid as $key => $value) {
                                $key++;
                                $tot=$tot+ $value["credit"];
                                echo '
                        			<tr>
						      	<td scope="row" align="right">('. $key .')</td>
                            ...
                            echo '
                                <tr>
                                    <td></td>
                                    <td>Total Paid</td>
                                    <td align="right"><h1>'. number_format($tot,2) .'</h1></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td><a href="'. URL .'dashboard">Go Back To Dashboard</a></td>
                                </tr>
