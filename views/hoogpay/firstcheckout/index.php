                ...
                <div class="lg:flex lg:space-x-12">
                    ...
                    <div class="lg:w-1/4 flex-shrink-0 space-y-5">
                        ...
                        echo ' <div class="card">';
                          ...
                          echo'<div style="font-weight: bold;font-size:0.7em; color:#429849;"> ORDER NO  : </div><div style="font-size: 0.8em;">'. substr($orderno, 12) .'</div>
                          		<div style="font-size: 0.9em;"> DATE     : '. $trndate .'</div>
                          		<div style="font-size: 0.9em;"> TOTAL =N=: '. number_format($deposit ).'</div><br>

                          		<div style="font-size: 0.9em; color:#D35400;">You are paying a deposit for '.$pqty.' plot(s) of land at '. $pname .'</div>
                          ...
                          echo '<form id="paymentForm" action="'. URL.$temurl .'" method="post" >
                          ...
                          <div class="form-group">
                            ...
                            <input type="hidden" id="amount" value="'. $deposit .'" required />
                          </div>
