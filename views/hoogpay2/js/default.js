...
//get other variables
		...
		//at this point check the prepay records
		//if not successfully found, exit the app
		$.post("hoogpay2/prepaymentsearch",

	                        // {staffid(in database):sid(variable here)etc},

	                        {amount:amount,sentfrom:sentfrom},

	                        function (data) {

	                        	
	                        	if(data.s_status=="Yes"){
	                        		//do all the approval works here
