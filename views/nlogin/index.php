    ...
    <div class="lg:flex max-w-5xl min-h-screen mx-auto p-6 py-10">
        <div class="flex flex-col items-center lg: lg:flex-row lg:space-x-10">
            ...
            <div class="lg:mb-12 flex-1 lg:text-left text-center">
                ...
                <marquee><h1>Get N10,000 Cash Prize for Having 20 Activations in Festive Promo</h1></marquee>
            ...
            <div class="lg:mt-0 lg:w-96 md:w-1/2 sm:w-2/3 mt-10 w-full">
              ...
              <?php
              session::init();
              if(session::get("accountnotexist")){
                session::set("accountnotexist",false);    
                echo '
                <div>
                  BA or Agent Account Not Exist
                </div>
                ';
              }
              ?>
                
                  <form enctype="multipart/form-data" action="<?php URL ;?> balogin/login" method="post" class="p-6 space-y-4 relative bg-white shadow-lg rounded-lg">
                    <input type="Number" placeholder="Phone Number" name="mobile" id="phone" class="with-border" required>
