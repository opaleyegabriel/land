...
?>
  ...
  border-spacing: 10 30px;">
                                  <thead>
                                      <tr>
                                          <td>SNO</td><td>Transaction Date</td><td>Amount Paid</td>
                                      </tr>
                                  </thead>
                                  <tbody>
                                  <?php
                                  ...
                                  $topay=0;
                                        foreach ($this->getdetails as $key => $value) {
                                            ...
                                            $tdate=$value["created_at"];
                                            $amt=$value['credit'];
                                            $totamt = $amt+$value['credit'];
                                            if($topay > 0){}else{
                                            	$topay=$value["debit"];
                                            }
                                  ...
                                  <?php 
                                  	echo '<h2 class="text-xl font-semibold mt-7">Name  : '. $name .' </h2>';
                                  //	echo 'Name  : '. $name .'  <br/>';
                                  	echo 'Total Plot Purchased  : ' . $qty. ' <br/>';
                                  	echo 'Amount to Pay : '. $topay .' <br/>';
                                  	echo 'Amount to Paid : '. $totamt . '<br/>';
                                  	echo 'Total Balance: '. number_format($topay-$totamt) .  '<br/>';
