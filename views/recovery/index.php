...
?>
  ...
  border-spacing: 0 20px;">
                                  <thead>
                                      <tr>
                                          <td>@NO</td><td>Client Name</td><td>Mobile</td><td>Plot</td><td>TE.Amount</td><td>Paid</td><td>Balance</td> <td>Due</td>
                                      </tr>
                                  </thead>
                                  <tbody>
                                  <?php
                                        ...
                                        foreach ($this->dueslist as $key => $value) {
                                           ...
                                           echo '
                                              ...
                                              echo      '<td><a style="text-decoration:none;color:#cc0000;background-color:#cc0000; border:1px solid #660000; border-radius:7px; color:#fff; margin-right:10px; margin-bottom:20px;
                                                      padding:10px 10px 10px 10px;" href="'.URL.'recovery/details/'.$id .'">'.$value["mobile"].'</a>
