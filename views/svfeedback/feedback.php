    ...
    <div id="wrapper">
        ...
        <div class="main_content">
            <div class="mcontainer">
                ...
                <h2 class="text-xl font-semibold mt-7"> Site Visit FeedBack Treatment</h2>
                 <?php
                   // echo "<pre>";
                   // print_r($this->selectedsitevisitrecords);
                    function Branch(int $a){
                        if ($a==1){
                            return "Ilorin Branch";
                        }
                            
                        if ($a==2){
                            return "Osogbo Branch";
                        }
                            
                        if ($a==3){
                            return "Ibadan Branch"; 
                        }

                    }
                    $result=$this->selectedsitevisitrecords;
                    /*
              ...
              echo  ' <form method="POST" enctype="multipart/form-data" action="' . URL . 'svfeedback/treatfeedback">
                        <label> From:  '. $branch .'</label>
                        <input type="hidden" value="'. $result["branchid"].'" readOnly name="requestby" >
                        <input type="text" value=" Site visited is '.$result["site"].'" readOnly name="site" >
                        <input type="text" value=" Through Site Supervisor  '.$result["requestby"].'" readOnly name="site" >
                        <input type="text" value=" Purpose is :  '.$result["purpose"].'" readOnly >
                        <input type="text" value=" Movement Approval comment: '.$result["comment"].'" readOnly>
                        <label> Feedback</label>
                        <input type="text" value=" Client Inf: '.$result["client"].'" readOnly>
                        <input type="text" value=" Satisfied?  : '.$result["pleased"].'" readOnly>
                        <input type="text" value=" Site Supervisor Feedback : '.$result["feedback"].'" readOnly>
                        <input type="text" name="admincomment" placeholder="Admin Resolutions" required>
                        <input type="hidden" value="'.$result["id"].'" name="id">
                        

                        <input type="submit" value="Update as Treated">
