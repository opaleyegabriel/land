...
?>             
        ...
        <div class="main_content">
            <div class="mcontainer">
                ...
                <h2 class="text-xl font-semibold mt-7"> Site Visit FeedBack</h2>
                 <?php
                   // echo "<pre>";
              ...
              echo  ' <form method="POST" enctype="multipart/form-data" action="' . URL . 'svrequest/submitfeedback">
                        
                        <input type="hidden" value="'. $result["branchid"].'" readOnly name="requestby" >
                        <input type="text" value=" Your visit to '.$result["site"].'" readOnly name="site" >
                        <input type="hidden" value="'.$result["id"].'" name="id">
                        <label>Is the client Pleased!</label>
                        <select name="pleased">
                          <option value="YES">YES</option>
                          <option value="NO">NO</option>                          
                        </select>
                        <input type="text"  name="client" placeholder=" Client names and Phone number" >
                        <input type="text" placeholder="Give detail feedback" name="feedback">
