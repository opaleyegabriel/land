                       ...
                       // <div class="card-media h-28" id="demodiv">Final Opportunity on Peace City and New Town Estate FESTIVE PROMO ends in <p id="demo"></p></div>
                        ...
                        <div class="container">
                              ...
                              <table border="2">
                                  <thead>
                                      <tr>
                                          <td>@NO</td><td>Client Name</td><td>Mobile</td><td>Amount Paid</td><td>3%</td>
                                      </tr>
                                  </thead>
                                  <tbody>
                                  <?php
                                 // echo "<pre>";
                                  ...
                                  $amtpaidtot=0;
                                  $sno=1;
                                        foreach ($this->calcpcent1 as $key => $value) {
                                            
                                            $p3=0;
                                            $p3=($value["credit"] * 0.03);
                                            $amtpaidtot=($value['credit'] + $amtpaidtot);
                                           echo '
                                                    <tr>
                                                    <td>'. $sno .'</td>
                                  ...
                                  <?php
                                  echo "Total Amount Paid = ". number_format($amtpaidtot);
                                  echo "   3% = ". number_format($amtpaidtot * 0.03);  
